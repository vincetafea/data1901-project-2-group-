...
scatter1 <- ggplot(top_5_df, aes(x = long, y = lat, colour = Signed)) + 
  ...
  scale_y_continuous(name = "Latitude°N",
                     ...
                     limits=  c(65.5,67.5)) +
  labs(
       title = expression(bold("Figure 4")),
       subtitle = expression(italic("Visualization of Density")),
       fill = "Style Dating"
       ) +
scale_colour_discrete_qualitative(l1 = 70) +
  theme_igray()
...
top_carvers <- c(rep("Åsmund", 5), rep("Balle", 5), rep("Fot", 5), rep("Öpir", 5), rep("Visäte", 5))
...
graph <- ggplot(data, aes(y=totals, x=top_carvers, fill=types)) +
  geom_bar(position="stack", stat = "identity") + 
  labs(x = "Top Carvers", y = "Number of Cross Types", fill = "Cross Types")
